  ...
  return (
    <div className="university-card">
      <div className="university-card__image-container">
        <img src={university.url} alt={university.name} className="university-card__image" />
      </div>
      <div className="university-card__details">
        <div className="university-card__name">{university.name}</div>
        <div className="university-card__location">{university.region}, {university.country}</div>
