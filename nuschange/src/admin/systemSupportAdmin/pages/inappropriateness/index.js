...
const Inappropriateness = () => {
    ...
    const buttons = [{ label: "PUReview", category: "PUReview" }, { label: "ForumComment", category: "ForumComment" }, { label: "ForumPost", category: "ForumPost" }, { label: "ForumTopic", category: "ForumTopic" }, { label: "PUModuleReview", category: "PUModuleReview" },];
                        ...
                        <div className="btn-group">
                            {buttons.map(({ label, category }) => (
                                <button
                                    key={category}
                                    type="button"
                                    className={`btn ${category === selectedButton ? "btn-primary" : "btn-outline-dark"}`}
