                ...
                <div className="card">
                    <div className="card card-primary">
                        <div className="card-header">
                            <h3 className="card-title">View Forum Post Details</h3>
                        </div>
                        <div className="card-body">
                            <div className="form-group">
                                <label htmlFor="inputStudent">Title</label>
                                <input type="text" id="inputStudent" className="form-control" value={title} readOnly />
                            </div>
                            <div className="form-group">
